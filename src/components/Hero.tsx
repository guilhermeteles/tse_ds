          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Bem-vindo ao nosso Sistema de Design!
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Nosso sistema de design foi cuidadosamente criado para fornecer uma experiência de usuário consistente e agradável em todas as nossas aplicações.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Primeiros passos</Button>
